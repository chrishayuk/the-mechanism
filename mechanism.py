...
videos/the-mechanism/ (no dependency on fleet experiment dirs).
  ...
  python3 mechanism.py decode     Part 3.0 — the model PACKS too: one residual, 3 facts read out (polysemantic) (Gemma)
  ...
  python3 mechanism.py all        run all nine in order
...
CAPS = ["pack", "wall", "decode", "layers", "trace", "address", "route", "ffn", "native"]
